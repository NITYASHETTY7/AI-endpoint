...
def apply_rate_limit(user_id: str):
    ...
    # KEEP track of how many requests specific user makes within certain time window
    user_requests[user_id] = [
        t for t in user_requests[user_id] if t > current_time - time_window
    ]
#block it if it exceeds that limit
...
#in-memory dictionary to store history of requests
